# IndiaBIX APtitube&DataInterpretation&MedicalScience Scraper
## Overview
...
| CorrectOption  | Stores the correct option                       |
| CorrectAnswer  | The correct option for the question             |
| Explanation    | Explains how the answer is correct              |
## Technologies Used
...
3. For each topic, it identifies sub-sections.
...
## IndiaBix Aptitude&DataInterpretation&MedicalScience Scraper with MySQL Storage
## Description
